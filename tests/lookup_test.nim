...
proc testKnightMove(debug: bool)=
  let friend = 0u64
  assertBitboard(lTable.knightMove(A1, friend), 0x0000000000020400u64, "wrong move for knight at A1", debug)
  assertBitboard(lTable.knightMove(B1, friend), 0x0000000000050800u64, "wrong move for knight at B1", debug)
  assertBitboard(lTable.knightMove(C1, friend), 0x00000000000A1100u64, "wrong move for knight at C1", debug)
  assertBitboard(lTable.knightMove(D1, friend), 0x0000000000142200u64, "wrong move for knight at D1", debug)
  assertBitboard(lTable.knightMove(E1, friend), 0x0000000000284400u64, "wrong move for knight at E1", debug)
  assertBitboard(lTable.knightMove(F1, friend), 0x0000000000508800u64, "wrong move for knight at F1", debug)
  assertBitboard(lTable.knightMove(G1, friend), 0x0000000000A01000u64, "wrong move for knight at G1", debug)
  assertBitboard(lTable.knightMove(H1, friend), 0x0000000000402000u64, "wrong move for knight at H1", debug)
  assertBitboard(lTable.knightMove(A2, friend), 0x0000000002040004u64, "wrong move for knight at A2", debug)
  assertBitboard(lTable.knightMove(B2, friend), 0x0000000005080008u64, "wrong move for knight at B2", debug)
  assertBitboard(lTable.knightMove(C2, friend), 0x000000000A110011u64, "wrong move for knight at C2", debug)
  assertBitboard(lTable.knightMove(D2, friend), 0x0000000014220022u64, "wrong move for knight at D2", debug)
  assertBitboard(lTable.knightMove(E2, friend), 0x0000000028440044u64, "wrong move for knight at E2", debug)
  assertBitboard(lTable.knightMove(F2, friend), 0x0000000050880088u64, "wrong move for knight at F2", debug)
  assertBitboard(lTable.knightMove(G2, friend), 0x00000000A0100010u64, "wrong move for knight at G2", debug)
  assertBitboard(lTable.knightMove(H2, friend), 0x0000000040200020u64, "wrong move for knight at H2", debug)
  assertBitboard(lTable.knightMove(A3, friend), 0x0000000204000402u64, "wrong move for knight at A3", debug)
  assertBitboard(lTable.knightMove(B3, friend), 0x0000000508000805u64, "wrong move for knight at B3", debug)
  assertBitboard(lTable.knightMove(C3, friend), 0x0000000A1100110Au64, "wrong move for knight at C3", debug)
  assertBitboard(lTable.knightMove(D3, friend), 0x0000001422002214u64, "wrong move for knight at D3", debug)
  assertBitboard(lTable.knightMove(E3, friend), 0x0000002844004428u64, "wrong move for knight at E3", debug)
  assertBitboard(lTable.knightMove(F3, friend), 0x0000005088008850u64, "wrong move for knight at F3", debug)
  assertBitboard(lTable.knightMove(G3, friend), 0x000000A0100010A0u64, "wrong move for knight at G3", debug)
  assertBitboard(lTable.knightMove(H3, friend), 0x0000004020002040u64, "wrong move for knight at H3", debug)
  assertBitboard(lTable.knightMove(A4, friend), 0x0000020400040200u64, "wrong move for knight at A4", debug)
  assertBitboard(lTable.knightMove(B4, friend), 0x0000050800080500u64, "wrong move for knight at B4", debug)
  assertBitboard(lTable.knightMove(C4, friend), 0x00000A1100110A00u64, "wrong move for knight at C4", debug)
  assertBitboard(lTable.knightMove(D4, friend), 0x0000142200221400u64, "wrong move for knight at D4", debug)
  assertBitboard(lTable.knightMove(E4, friend), 0x0000284400442800u64, "wrong move for knight at E4", debug)
  assertBitboard(lTable.knightMove(F4, friend), 0x0000508800885000u64, "wrong move for knight at F4", debug)
  assertBitboard(lTable.knightMove(G4, friend), 0x0000A0100010A000u64, "wrong move for knight at G4", debug)
  assertBitboard(lTable.knightMove(H4, friend), 0x0000402000204000u64, "wrong move for knight at H4", debug)
  assertBitboard(lTable.knightMove(A5, friend), 0x0002040004020000u64, "wrong move for knight at A5", debug)
  assertBitboard(lTable.knightMove(B5, friend), 0x0005080008050000u64, "wrong move for knight at B5", debug)
  assertBitboard(lTable.knightMove(C5, friend), 0x000A1100110A0000u64, "wrong move for knight at C5", debug)
  assertBitboard(lTable.knightMove(D5, friend), 0x0014220022140000u64, "wrong move for knight at D5", debug)
  assertBitboard(lTable.knightMove(E5, friend), 0x0028440044280000u64, "wrong move for knight at E5", debug)
  assertBitboard(lTable.knightMove(F5, friend), 0x0050880088500000u64, "wrong move for knight at F5", debug)
  assertBitboard(lTable.knightMove(G5, friend), 0x00A0100010A00000u64, "wrong move for knight at G5", debug)
  assertBitboard(lTable.knightMove(H5, friend), 0x0040200020400000u64, "wrong move for knight at H5", debug)
  assertBitboard(lTable.knightMove(A6, friend), 0x0204000402000000u64, "wrong move for knight at A6", debug)
  assertBitboard(lTable.knightMove(B6, friend), 0x0508000805000000u64, "wrong move for knight at B6", debug)
  assertBitboard(lTable.knightMove(C6, friend), 0x0A1100110A000000u64, "wrong move for knight at C6", debug)
  assertBitboard(lTable.knightMove(D6, friend), 0x1422002214000000u64, "wrong move for knight at D6", debug)
  assertBitboard(lTable.knightMove(E6, friend), 0x2844004428000000u64, "wrong move for knight at E6", debug)
  assertBitboard(lTable.knightMove(F6, friend), 0x5088008850000000u64, "wrong move for knight at F6", debug)
  assertBitboard(lTable.knightMove(G6, friend), 0xA0100010A0000000u64, "wrong move for knight at G6", debug)
  assertBitboard(lTable.knightMove(H6, friend), 0x4020002040000000u64, "wrong move for knight at H6", debug)
  assertBitboard(lTable.knightMove(A7, friend), 0x0400040200000000u64, "wrong move for knight at A7", debug)
  assertBitboard(lTable.knightMove(B7, friend), 0x0800080500000000u64, "wrong move for knight at B7", debug)
  assertBitboard(lTable.knightMove(C7, friend), 0x1100110A00000000u64, "wrong move for knight at C7", debug)
  assertBitboard(lTable.knightMove(D7, friend), 0x2200221400000000u64, "wrong move for knight at D7", debug)
  assertBitboard(lTable.knightMove(E7, friend), 0x4400442800000000u64, "wrong move for knight at E7", debug)
  assertBitboard(lTable.knightMove(F7, friend), 0x8800885000000000u64, "wrong move for knight at F7", debug)
  assertBitboard(lTable.knightMove(G7, friend), 0x100010A000000000u64, "wrong move for knight at G7", debug)
  assertBitboard(lTable.knightMove(H7, friend), 0x2000204000000000u64, "wrong move for knight at H7", debug)
  assertBitboard(lTable.knightMove(A8, friend), 0x0004020000000000u64, "wrong move for knight at A8", debug)
  assertBitboard(lTable.knightMove(B8, friend), 0x0008050000000000u64, "wrong move for knight at B8", debug)
  assertBitboard(lTable.knightMove(C8, friend), 0x00110A0000000000u64, "wrong move for knight at C8", debug)
  assertBitboard(lTable.knightMove(D8, friend), 0x0022140000000000u64, "wrong move for knight at D8", debug)
  assertBitboard(lTable.knightMove(E8, friend), 0x0044280000000000u64, "wrong move for knight at E8", debug)
  assertBitboard(lTable.knightMove(F8, friend), 0x0088500000000000u64, "wrong move for knight at F8", debug)
  assertBitboard(lTable.knightMove(G8, friend), 0x0010A00000000000u64, "wrong move for knight at G8", debug)
  assertBitboard(lTable.knightMove(H8, friend), 0x0020400000000000u64, "wrong move for knight at H8", debug)

proc testKingMove(debug: bool)=
  let friend = 0u64
  assertBitboard(lTable.kingMove(A1, friend), 0x0000000000000302u64, "wrong move for king at A1", debug)
  assertBitboard(lTable.kingMove(B1, friend), 0x0000000000000705u64, "wrong move for king at B1", debug)
  assertBitboard(lTable.kingMove(C1, friend), 0x0000000000000E0Au64, "wrong move for king at C1", debug)
  assertBitboard(lTable.kingMove(D1, friend), 0x0000000000001C14u64, "wrong move for king at D1", debug)
  assertBitboard(lTable.kingMove(E1, friend), 0x0000000000003828u64, "wrong move for king at E1", debug)
  assertBitboard(lTable.kingMove(F1, friend), 0x0000000000007050u64, "wrong move for king at F1", debug)
  assertBitboard(lTable.kingMove(G1, friend), 0x000000000000E0A0u64, "wrong move for king at G1", debug)
  assertBitboard(lTable.kingMove(H1, friend), 0x000000000000C040u64, "wrong move for king at H1", debug)
  assertBitboard(lTable.kingMove(A2, friend), 0x0000000000030203u64, "wrong move for king at A2", debug)
  assertBitboard(lTable.kingMove(B2, friend), 0x0000000000070507u64, "wrong move for king at B2", debug)
  assertBitboard(lTable.kingMove(C2, friend), 0x00000000000E0A0Eu64, "wrong move for king at C2", debug)
  assertBitboard(lTable.kingMove(D2, friend), 0x00000000001C141Cu64, "wrong move for king at D2", debug)
  assertBitboard(lTable.kingMove(E2, friend), 0x0000000000382838u64, "wrong move for king at E2", debug)
  assertBitboard(lTable.kingMove(F2, friend), 0x0000000000705070u64, "wrong move for king at F2", debug)
  assertBitboard(lTable.kingMove(G2, friend), 0x0000000000E0A0E0u64, "wrong move for king at G2", debug)
  assertBitboard(lTable.kingMove(H2, friend), 0x0000000000C040C0u64, "wrong move for king at H2", debug)
  assertBitboard(lTable.kingMove(A3, friend), 0x0000000003020300u64, "wrong move for king at A3", debug)
  assertBitboard(lTable.kingMove(B3, friend), 0x0000000007050700u64, "wrong move for king at B3", debug)
  assertBitboard(lTable.kingMove(C3, friend), 0x000000000E0A0E00u64, "wrong move for king at C3", debug)
  assertBitboard(lTable.kingMove(D3, friend), 0x000000001C141C00u64, "wrong move for king at D3", debug)
  assertBitboard(lTable.kingMove(E3, friend), 0x0000000038283800u64, "wrong move for king at E3", debug)
  assertBitboard(lTable.kingMove(F3, friend), 0x0000000070507000u64, "wrong move for king at F3", debug)
  assertBitboard(lTable.kingMove(G3, friend), 0x00000000E0A0E000u64, "wrong move for king at G3", debug)
  assertBitboard(lTable.kingMove(H3, friend), 0x00000000C040C000u64, "wrong move for king at H3", debug)
  assertBitboard(lTable.kingMove(A4, friend), 0x0000000302030000u64, "wrong move for king at A4", debug)
  assertBitboard(lTable.kingMove(B4, friend), 0x0000000705070000u64, "wrong move for king at B4", debug)
  assertBitboard(lTable.kingMove(C4, friend), 0x0000000E0A0E0000u64, "wrong move for king at C4", debug)
  assertBitboard(lTable.kingMove(D4, friend), 0x0000001C141C0000u64, "wrong move for king at D4", debug)
  assertBitboard(lTable.kingMove(E4, friend), 0x0000003828380000u64, "wrong move for king at E4", debug)
  assertBitboard(lTable.kingMove(F4, friend), 0x0000007050700000u64, "wrong move for king at F4", debug)
  assertBitboard(lTable.kingMove(G4, friend), 0x000000E0A0E00000u64, "wrong move for king at G4", debug)
  assertBitboard(lTable.kingMove(H4, friend), 0x000000C040C00000u64, "wrong move for king at H4", debug)
  assertBitboard(lTable.kingMove(A5, friend), 0x0000030203000000u64, "wrong move for king at A5", debug)
  assertBitboard(lTable.kingMove(B5, friend), 0x0000070507000000u64, "wrong move for king at B5", debug)
  assertBitboard(lTable.kingMove(C5, friend), 0x00000E0A0E000000u64, "wrong move for king at C5", debug)
  assertBitboard(lTable.kingMove(D5, friend), 0x00001C141C000000u64, "wrong move for king at D5", debug)
  assertBitboard(lTable.kingMove(E5, friend), 0x0000382838000000u64, "wrong move for king at E5", debug)
  assertBitboard(lTable.kingMove(F5, friend), 0x0000705070000000u64, "wrong move for king at F5", debug)
  assertBitboard(lTable.kingMove(G5, friend), 0x0000E0A0E0000000u64, "wrong move for king at G5", debug)
  assertBitboard(lTable.kingMove(H5, friend), 0x0000C040C0000000u64, "wrong move for king at H5", debug)
  assertBitboard(lTable.kingMove(A6, friend), 0x0003020300000000u64, "wrong move for king at A6", debug)
  assertBitboard(lTable.kingMove(B6, friend), 0x0007050700000000u64, "wrong move for king at B6", debug)
  assertBitboard(lTable.kingMove(C6, friend), 0x000E0A0E00000000u64, "wrong move for king at C6", debug)
  assertBitboard(lTable.kingMove(D6, friend), 0x001C141C00000000u64, "wrong move for king at D6", debug)
  assertBitboard(lTable.kingMove(E6, friend), 0x0038283800000000u64, "wrong move for king at E6", debug)
  assertBitboard(lTable.kingMove(F6, friend), 0x0070507000000000u64, "wrong move for king at F6", debug)
  assertBitboard(lTable.kingMove(G6, friend), 0x00E0A0E000000000u64, "wrong move for king at G6", debug)
  assertBitboard(lTable.kingMove(H6, friend), 0x00C040C000000000u64, "wrong move for king at H6", debug)
  assertBitboard(lTable.kingMove(A7, friend), 0x0302030000000000u64, "wrong move for king at A7", debug)
  assertBitboard(lTable.kingMove(B7, friend), 0x0705070000000000u64, "wrong move for king at B7", debug)
  assertBitboard(lTable.kingMove(C7, friend), 0x0E0A0E0000000000u64, "wrong move for king at C7", debug)
  assertBitboard(lTable.kingMove(D7, friend), 0x1C141C0000000000u64, "wrong move for king at D7", debug)
  assertBitboard(lTable.kingMove(E7, friend), 0x3828380000000000u64, "wrong move for king at E7", debug)
  assertBitboard(lTable.kingMove(F7, friend), 0x7050700000000000u64, "wrong move for king at F7", debug)
  assertBitboard(lTable.kingMove(G7, friend), 0xE0A0E00000000000u64, "wrong move for king at G7", debug)
  assertBitboard(lTable.kingMove(H7, friend), 0xC040C00000000000u64, "wrong move for king at H7", debug)
  assertBitboard(lTable.kingMove(A8, friend), 0x0203000000000000u64, "wrong move for king at A8", debug)
  assertBitboard(lTable.kingMove(B8, friend), 0x0507000000000000u64, "wrong move for king at B8", debug)
  assertBitboard(lTable.kingMove(C8, friend), 0x0A0E000000000000u64, "wrong move for king at C8", debug)
  assertBitboard(lTable.kingMove(D8, friend), 0x141C000000000000u64, "wrong move for king at D8", debug)
  assertBitboard(lTable.kingMove(E8, friend), 0x2838000000000000u64, "wrong move for king at E8", debug)
  assertBitboard(lTable.kingMove(F8, friend), 0x5070000000000000u64, "wrong move for king at F8", debug)
  assertBitboard(lTable.kingMove(G8, friend), 0xA0E0000000000000u64, "wrong move for king at G8", debug)
  assertBitboard(lTable.kingMove(H8, friend), 0x40C0000000000000u64, "wrong move for king at H8", debug)
